    ...
    <>
      ...
      <Section background="primary" spacing="lg">
        <div className="text-center text-white">
          <H2 className="text-white mb-4">Ready to Scale Your Toronto Business?</H2>
          <Paragraph className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
            Join 220+ Toronto businesses that have transformed their operations with smart virtual assistants
          </Paragraph>
